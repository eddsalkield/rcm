...
$XDG_CONFIG_HOME has not been set, so should default to $HOME/.config

  $ unset XDG_CONFIG_HOME
  $ unset RCRC
  $ export XDG_CONFIG_HOME_2="$HOME/.config"
  ...
  $ echo 'DOTFILES_DIRS="$HOME/.other-dotfiles-xdg-config-home"' > $XDG_CONFIG_HOME_2/rcm/rcrc
